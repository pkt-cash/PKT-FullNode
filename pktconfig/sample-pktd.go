...
; The default is ~/.pktd/data on POSIX OSes, $LOCALAPPDATA/Pktd/data on Windows,
; ~/Library/Application Support/Pktd/data on Mac OS, and $home/btcd/data on
...
; Use pkt.cash mainnet.
; pkt=1

; Use bitcoin mainnet.
; btc=1

; Use pkt.cash testnet.
; pkttest=1
