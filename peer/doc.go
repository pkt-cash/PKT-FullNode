...
function which allows a pktlog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/pkt-cash/PKT-FullNode/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
