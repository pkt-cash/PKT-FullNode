...
// header type.
func (h *headerStore) readRaw(seekDist uint64) ([]byte, er.R) {
...
func (h *blockHeaderStore) readHeader(height uint32) (wire.BlockHeader, er.R) {
...
// flat files on disk.
func (f *FilterHeaderStore) readHeader(height uint32) (*chainhash.Hash, er.R) {
