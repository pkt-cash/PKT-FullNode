...
func (r FutureGetGenerateResult) Receive() (bool, er.R) {
	res, err := receiveFuture(r)
	if err != nil {
		return false, err
	}
...
func (c *Client) GetGenerate() (bool, er.R) {
...
func (r FutureSetGenerateResult) Receive() er.R {
...
func (c *Client) SetGenerate(enable bool, numCPUs int) er.R {
...
func (r FutureGetHashesPerSecResult) Receive() (int64, er.R) {
	res, err := receiveFuture(r)
	if err != nil {
		return -1, err
	}
...
// mining.
func (c *Client) GetHashesPerSec() (int64, er.R) {
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*btcjson.GetMiningInfoResult, er.R) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetMiningInfo() (*btcjson.GetMiningInfoResult, er.R) {
...
// parameters.
func (r FutureGetNetworkHashPS) Receive() (int64, er.R) {
	res, err := receiveFuture(r)
	if err != nil {
		return -1, err
	}
...
func (c *Client) GetNetworkHashPS() (int64, er.R) {
...
func (c *Client) GetNetworkHashPS2(blocks int) (int64, er.R) {
...
func (c *Client) GetNetworkHashPS3(blocks, height int) (int64, er.R) {
...
// data to work on.
func (r FutureGetWork) Receive() (*btcjson.GetWorkResult, er.R) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWork() (*btcjson.GetWorkResult, er.R) {
...
func (r FutureGetWorkSubmit) Receive() (bool, er.R) {
	res, err := receiveFuture(r)
	if err != nil {
		return false, err
	}
...
func (c *Client) GetWorkSubmit(data string) (bool, er.R) {
