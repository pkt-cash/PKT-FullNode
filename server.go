...
import (
	...
	"github.com/pkt-cash/PKT-FullNode/mining/cpuminer"
	"github.com/pkt-cash/PKT-FullNode/netsync"
...
func newServer(listenAddrs, agentBlacklist, agentWhitelist []string,
	...
	if len(indexes) > 0 {
		indexManager = indexers.NewManager(db, indexes, s.votes.VoteCompute())
	}
