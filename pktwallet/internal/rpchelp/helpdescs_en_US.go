...
var helpDescsEnUS = map[string]string{
	...
	"getaddressbalancesresult-simmaturereward": "Mined coins which have not yet matured (atomic units as base 10 string)",
	"getaddressbalancesresult-spendable":       "Balance which is currently spendable",
	"getaddressbalancesresult-sspendable":      "Balance which is currently spendable (atomic units as base 10 string)",
	"getaddressbalancesresult-total":           "Total balance",
	"getaddressbalancesresult-stotal":          "Total balance (atomic units as base 10 string)",
	"getaddressbalancesresult-unconfirmed":     "Unconfirmed balance",
